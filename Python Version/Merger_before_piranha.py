...
# --macos-app-name="CSV Merger App" --onefile --enable-plugin=pyqt5 Merger_1008.py
...
class App(QMainWindow):
    def __init__(self):
        ...
        self.en_btn.setStyleSheet("QPushButton"
                                  "{"
        ...
        self.fr_btn.setGeometry(int(screen_width * 0.94), int(screen_height * 0.02), int(screen_width * 0.05),
                                int(screen_height * 0.05))
        self.fr_btn.setStyleSheet("QPushButton"
                                  "{"
                                  "color: white; border-radius: 15px;background-color:#2e3192;"
                                  "border-color:black;border-style: solid;border-width: 1px;"
                                  "}"
        ...
        self.listbox_view.setGeometry(int(screen_width * 0.12), int(screen_height * 0.11), int(screen_width * 0.63),
                                      int(screen_height * 0.25))  # box position and dimension 100, 290, 950, 350

        self.listbox_label = QLabel('Dropbox:', self)
        self.listbox_label.setStyleSheet("background-color:transparent")
        self.listbox_label.setGeometry(int(screen_width * 0.02), int(screen_height * 0.21), int(screen_width * 0.2),
                                       int(screen_height * 0.05))  
        ...
        self.destination_entry.setStyleSheet("background-color:#FAF9F6;border-color:lightgrey;border-style: "
                                             "dashed;border-width: 2px;border-radius: 10px;")
        self.destination_entry.setGeometry(int(screen_width * 0.12), int(screen_height * 0.54), int(screen_width * 0.63),
        ...
        self.destination_label.setGeometry(int(screen_width * 0.02), int(screen_height * 0.54), int(screen_width * 0.2),
                                           int(screen_height * 0.05))  
        ...
        self.epi_entry.setStyleSheet("background-color:#FAF9F6;border-color:lightgrey;border-style: "
                                             "dashed;border-width: 2px;border-radius: 10px;")
        self.epi_entry.setGeometry(int(screen_width * 0.12), int(screen_height * 0.4), int(screen_width * 0.63),
        ...
        self.epi_label.setGeometry(int(screen_width * 0.02), int(screen_height * 0.4), int(screen_width * 0.2),
                                           int(screen_height * 0.05))  
        ...
        self.lab_entry.setStyleSheet("background-color:#FAF9F6;border-color:lightgrey;border-style: "
                                             "dashed;border-width: 2px;border-radius: 10px;")
        self.lab_entry.setGeometry(int(screen_width * 0.12), int(screen_height * 0.47), int(screen_width * 0.63),
                                           int(screen_height * 0.06))
        ...
        self.run_entry.setStyleSheet("background-color:#FAF9F6;border-color:lightgrey;border-style: "
                                             "dashed;border-width: 2px;border-radius: 10px;")
        ...
        self.date_seq_entry.setStyleSheet("background-color:#FAF9F6;border-color:lightgrey;border-style: "
                                             "dashed;border-width: 2px;border-radius: 10px;")
        ...
        self.seq_mach_entry.setStyleSheet("background-color:#FAF9F6;border-color:lightgrey;border-style: "
                                             "dashed;border-width: 2px;border-radius: 10px;")
        ...
        self.fc_id_entry.setStyleSheet("background-color:#FAF9F6;border-color:lightgrey;border-style: "
                                             "dashed;border-width: 2px;border-radius: 10px;")
        ...
        self.fc_ver_entry.setStyleSheet("background-color:#FAF9F6;border-color:lightgrey;border-style: "
                                             "dashed;border-width: 2px;border-radius: 10px;")
        ...
        self.fc_uses_entry.setStyleSheet("background-color:#FAF9F6;border-color:lightgrey;border-style: "
                                             "dashed;border-width: 2px;border-radius: 10px;")
        ...
        self.fc_pores_entry.setStyleSheet("background-color:#FAF9F6;border-color:lightgrey;border-style: "
                                             "dashed;border-width: 2px;border-radius: 10px;")
        ...
        self.run_time_entry.setStyleSheet("background-color:#FAF9F6;border-color:lightgrey;border-style: "
                                             "dashed;border-width: 2px;border-radius: 10px;")
        ...
        self.fasta_gen_entry.setStyleSheet("background-color:#FAF9F6;border-color:lightgrey;border-style: "
                                             "dashed;border-width: 2px;border-radius: 10px;")
        ...
        self.minknow_ver_entry.setStyleSheet("background-color:#FAF9F6;border-color:lightgrey;border-style: "
                                             "dashed;border-width: 2px;border-radius: 10px;")
        ...
        self.piranha_ver_entry.setStyleSheet("background-color:#FAF9F6;border-color:lightgrey;border-style: "
                                             "dashed;border-width: 2px;border-radius: 10px;")
        ...
        self.rtpcr_mach_entry.setStyleSheet("background-color:#FAF9F6;border-color:lightgrey;border-style: "
                                             "dashed;border-width: 2px;border-radius: 10px;")
        ...
        self.rtpcr_primers_entry.setStyleSheet("background-color:#FAF9F6;border-color:lightgrey;border-style: "
                                             "dashed;border-width: 2px;border-radius: 10px;")
        ...
        # primer options
        self.rtpcr_primers_entry.addItem("Y7+Cre+nOPV2-mm")
        self.rtpcr_primers_entry.addItem("5'NTR+Cre+nOPV2-mm")
        self.rtpcr_primers_entry.addItem("5'NTR+Cre")
        ...
        self.vp1_mach_entry.setStyleSheet("background-color:#FAF9F6;border-color:lightgrey;border-style: "
                                             "dashed;border-width: 2px;border-radius: 10px;")
        ...
        self.vp1_primers_entry.setStyleSheet("background-color:#FAF9F6;border-color:lightgrey;border-style: "
                                             "dashed;border-width: 2px;border-radius: 10px;")
        ...
        # primer options
        self.vp1_primers_entry.addItem("Y7+Q8")
    ...
    def concatenate_csv(self):
        ...
        try:
            epi_fmt = ['ICLabID','EpidNumber','CaseOrContact','Country','Province','District','StoolCondition',
        ...
        merged_df.to_csv(f'{destination_path}/barcodes.csv', index=False, encoding='utf-8')
